#usage (example):
#python3.4 single.py git_url=https://github.com/junit-team/junit.git source_path=demoRepo output_path=demoResult soda_rawDataReader_path=/home/geryxyz/soda_build/cl/SoDATools/utilities/rawdatareader

from soda import * 

print(info("Avaible doables."))
Doable.listKnownDoables()
